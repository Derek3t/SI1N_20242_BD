...
ALTER TABLE FORNECEDORES ADD FORNEC_EMAIL VARCHAR(50);  # Adicionando email do fornecedor
ALTER TABLE FILIAIS DROP COLUMN FILIAL_CAPACIDADE;  # Removendo coluna de capacidade da filial
ALTER TABLE PRODUTOS MODIFY COLUMN PROD_NOME VARCHAR(100);  # Modificando tamanho do nome do produto
ALTER TABLE PEDIDOS CHANGE COLUMN PED_DATA PED_DATA_COR VARCHAR(13);  # Alterando nome da coluna da data do pedido
ALTER TABLE RECEBIMENTOS ADD RECEB_NOTAS TEXT;  # Adicionando campo para notas sobre o recebimento
ALTER TABLE PEDIDOS_PRODUTOS ADD PDPR_PRECO_UNIT DECIMAL(10, 2);  # Adicionando preço unitário no pedido de produtos
ALTER TABLE FILIAIS_PRODUTOS DROP COLUMN FLPR_QUANT;  # Removendo coluna de quantidade da tabela filial-produtos
