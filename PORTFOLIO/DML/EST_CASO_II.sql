...
insert into passageiros (pass_nome, pass_cpf, pass_tel, pass_end, reserv_id)
values ('Jordan','124.922.837-16','27 99483-1984','Avenida Jorge Caramelo, nº 14', 13);

update passageiros
set pass_tel = '27 99847-2746' 
where pass_nome = 'Jordan';
