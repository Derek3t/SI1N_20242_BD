...
ENDERECOS,
PESSOA_CONTATO)
values ('12.345.678/0001-90','Empresa Fictícia Ltda.','Comércio de eletrônicos e acessórios','21/11/2002','Rua das Flores, 123, Centro, São Paulo - SP, 01000-000','Nome: Maria Silva
Cargo: Gerente de Vendas
Telefone: (11) 98765-4321
E-mail: maria.silva@email.com' );

update clientes
set razao_social = 'Empresa Dois Primos Ltda.' 
where data_cadastramento = '21/11/2002';
